...
{
    /// <inheritdoc />
    public partial class AddHrAndSupplierModule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payrolls_TenantId_EmployeeId_Period",
                table: "Payrolls",
                columns: new[] { "TenantId", "EmployeeId", "Period" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shifts_TenantId_BranchId_Date",
                table: "Shifts",
